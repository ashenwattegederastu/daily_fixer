            ...
            <c:choose>
                <c:when test="${not empty sessionScope.currentUser}">
                    ...
                    <a href="${pageContext.request.contextPath}/pages/dashboards/${sessionScope.currentUser.role}dash/${sessionScope.currentUser.role}dashmain.jsp"
                       class="btn-login" style="text-decoration: none; padding: 0.6rem 1.2rem; display: inline-block;">
                        Hi, ${sessionScope.currentUser.firstName}
                    </a>
                    <a href="${pageContext.request.contextPath}/logout" class="btn-logout" style="text-decoration: none;">Logout</a>
                </c:when>
                <c:otherwise>
                    <!-- Guest -->
...
<section class="hero-section active" id="hero1">
    <div class="hero-content">
        ...
        <c:choose>
            <c:when test="${not empty sessionScope.currentUser}">
                <a href="${pageContext.request.contextPath}/diagnostic.jsp" class="hero-cta">Start Diagnosing</a>
            </c:when>
            <c:otherwise>
                <a href="${pageContext.request.contextPath}/preliminarySignup.jsp" class="hero-cta">Get Started</a>
            </c:otherwise>
        </c:choose>
    </div>
