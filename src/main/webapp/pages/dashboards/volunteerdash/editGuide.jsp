...
<div class="container">
    <h2>Edit Guide</h2>
    <p style="color: var(--muted-foreground); margin-bottom: 20px;">Update your repair guide</p>
    ...
    <div class="form-container">
        <form action="${pageContext.request.contextPath}/EditGuideServlet" method="post" enctype="multipart/form-data">
            ...
            <div style="margin-top: 30px;">
                ...
                <a href="${pageContext.request.contextPath}/pages/dashboards/volunteerdash/myguides.jsp" class="back-btn">← Cancel</a>
            </div>
        </form>
    </div>
</div>
