                    ...
                    <div class="form-card">
                        ...
                        <form action="${pageContext.request.contextPath}/AddProductServlet" method="post"
                            ...
                            <div style="margin-top: 30px; padding-top: 20px; border-top: 2px solid var(--border);">
                                <h3 style="color: var(--primary); margin-bottom: 15px;">Product Variants (Optional)</h3>
                                <p style="font-size: 0.85em; color: var(--muted-foreground); margin-bottom: 15px;">
                                ...
                                <div id="variantsContainer">
                                    ...
                                    <div class="variant-row"
                                        style="background: var(--muted); padding: 15px; border-radius: var(--radius-md); margin-bottom: 15px; border: 1px solid var(--border);">
                                        <div
