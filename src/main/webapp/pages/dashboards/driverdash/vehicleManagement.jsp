...
.vehicle-form input, .vehicle-form button,.vehicle-form select {
    display: block; 
    margin: 12px 0; 
    width: 100%; 
    padding: 12px; 
...
<main class="container">
    ...
    <form id="addVehicleForm" action="${pageContext.request.contextPath}/AddVehicleServlet" method="post" enctype="multipart/form-data" class="vehicle-form">
        ...
        <!--Added a dropdown for vehicle types-->
        ...
        <input type="number" step="0.5" id="maxWeight" name="maxWeight" placeholder="Maximum Weight (kg)" required>
        <input type="number" step="1" id="maxVolume" name="maxVolume" placeholder="Maximum Volume (cm³)" required>
        <!--New fields for Max Weight , Volume -->
