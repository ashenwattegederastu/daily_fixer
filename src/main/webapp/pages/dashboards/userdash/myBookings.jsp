                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="${pageContext.request.contextPath}/pages/chat.jsp?tech=JohnSilva"
                                                    class="btn btn-message">Message</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="${pageContext.request.contextPath}/pages/chat.jsp?tech=NuwanPerera"
                                                    class="btn btn-message">Message</a>
                                                <a href="#" class="btn btn-details">Details</a>
                                                <a href="#" class="btn btn-cancel" onclick="showDialog()">Cancel</a>
                                            </div>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="${pageContext.request.contextPath}/pages/chat.jsp?tech=KusalJayawardena"
                                                    class="btn btn-message">Message</a>
                                                <a href="#" class="btn btn-details">Details</a>
                                                <a href="${pageContext.request.contextPath}/pages/dashboards/userdash/writeReview.jsp?item=ACRepair"
                                                    class="btn btn-review">Review</a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="${pageContext.request.contextPath}/pages/chat.jsp?tech=RajeshKumar"
                                                    class="btn btn-message">Message</a>
                                                <a href="#" class="btn btn-details">Details</a>
                                                <a href="${pageContext.request.contextPath}/pages/dashboards/userdash/writeReview.jsp?item=ApplianceRepair"
                                                    class="btn btn-review">Review</a>
                                            </div>
                                        </td>
                                    </tr>
